...
public class Hashmap<K, V> implements MapSet<K, V> {
    ...
    public String toString() {
        ...
        for (int i = 0; i < table.length; i++) {
            LinkedList<KeyValuePair<K, V>> current_bucket = getBucketAtIndex(i);
    ...
    public ArrayList<KeyValuePair<K, V>> entrySet() {
        // TODO Auto-generated method stub
        // FIXME: how to get the node in the Linked List. This same problem recurs
        // throughout and cannot be solved. thats why I can't access the methods in the
        // linked list.
    ...
    public V get(K key) {
        ...
        LinkedList<KeyValuePair<K, V>> existing = getBucketAtIndex(bucket_index);
    ...
    private LinkedList<KeyValuePair<K, V>> getBucketAtIndex(int bucket_index) {
        return (LinkedList<KeyValuePair<K, V>>) table[bucket_index];
    }
    ...
    public V put(K new_key, V new_value) {
        ...
        if (existing.size() == 0) {
            ...
            existing.addLast(new KeyValuePair<K, V>(new_key, new_value));
            numCollisions++;
            size++;
        }
    ...
    public ArrayList<V> values() {
        ...
        // having two loops seem computationally expensive?
    ...
    public void resize() {
        ...
        // RESIZE method
        // if load factor > size/capacity{resize()}
        // don"t need to check again?

        // rehash
        // System.out.println("expand");
        // LinkedList<KeyValuePair<K, V>>[] old = (LinkedList<KeyValuePair<K, V>>)table;
        // Object[] old = table;

        // resize
        // capacity *= 2;
        size = 0;
        // Object oldTable = table.clone();
        ...
        for (KeyValuePair<K, V> e : entrySet) {
            ...
            // why is it returning a object and v?
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Hashmap<String, String> hashMap = new Hashmap<>(new AscendingString());
