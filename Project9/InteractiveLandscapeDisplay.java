...
public class InteractiveLandscapeDisplay {
    ...
    public InteractiveLandscapeDisplay() {
        ...
        VertexProject v1 = new VertexProject(0, 0);
        v1.setVisible(true);
        v1.setCost(0);
        VertexProject v2 = new VertexProject(0, 1);
        v2.setVisible(true);
        v2.setCost(1);
        VertexProject v3 = new VertexProject(0, 2);
        v3.setVisible(true);
        v3.setCost(2);
        VertexProject v4 = new VertexProject(0, 3);
        v4.setVisible(true);
        v4.setCost(3);
        v1.connect(v2, Direction.SOUTH);
        v2.connect(v1, Direction.NORTH);
        v2.connect(v3, Direction.SOUTH);
        v3.connect(v2, Direction.NORTH);
        v3.connect(v4, Direction.SOUTH);
        v4.connect(v3, Direction.NORTH);
